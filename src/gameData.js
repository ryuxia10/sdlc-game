...
export const gameLevels = {
  'sdlc-planning': {
    ...
    description: "Selamat datang di tahap Planning! Sebelum membangun istana, kamu harus tahu apa saja yang Ratu Klien inginkan. Kamu harus mengumpulkan 'Permata Kebutuhan' yang akan menjadi bahan dasar petualanganmu!",
  ...
  'sdlc-analysis': {
    ...
    description: "Hebat! Sekarang kita di tahap Analysis. Di sini kita akan menyusun peta harta karun untuk Istana kita. Ini adalah tahapan untuk mengurai semua kebutuhan dan membuatnya menjadi sebuah cetak biru.",
    missionText: "Misi: Susun 'Ramuan Alur Proses' dengan mencocokkan 3 emoji (🧪).",
    emoji: '🧪',
    game: {
      type: 'analysis',
    ...
    material: {
      ...
      description: "Setelah tahu apa yang dibutuhkan, kita masuk ke tahap **Analysis**. Di sini, kita akan menganalisis semua kebutuhan tersebut dan mengubahnya menjadi spesifikasi yang lebih detail. Seperti menyusun potongan puzzle, kita mengurai kebutuhan Ratu Klien dan menyusunnya menjadi alur proses yang logis. Tahap ini sangat penting agar semua anggota tim memiliki pemahaman yang sama.",
    },
  },
  'sdlc-design': {
    title: "Bengkel Arsitek",
    description: "Waktunya masuk ke tahap Design! Kamu harus merancang fondasi yang kokoh untuk Istana. Di sini kita akan menentukan bagaimana struktur basis data dan arsitektur sistem akan dibuat.",
    missionText: "Misi: Rancang 'Pondasi Basis Data' dengan menyusun 3 emoji (🧱).",
    emoji: '🧱',
    game: {
      type: 'design',
      blueprint: [
  ...
  'sdlc-implementation': {
    ...
    description: "Selamat datang di tahap Implementation! Ini adalah tempat keajaiban terjadi. Kamu akan menggunakan Gulungan Kode Ajaib untuk membangun setiap bagian istana.",
    ...
    game: {
      ...
      correctOrder: ['function-start', 'loop-start', 'action', 'loop-end', 'function-end'],
      codePieces: [
        { id: 'piece-1', emoji: '📜', type: 'loop-start', label: 'Loop (for...)' },
        { id: 'piece-2', emoji: '📜', type: 'action', label: 'Action (print...)' },
        { id: 'piece-3', emoji: '📜', type: 'function-start', label: 'Function (def...)' },
        { id: 'piece-4', emoji: '📜', type: 'loop-end', label: 'End Loop (...)' },
        { id: 'piece-5', emoji: '📜', type: 'function-end', label: 'End Function' },
      ],
    },
    material: {
      title: "Materi: Apa Itu SDLC - Tahap Implementation?",
      description: "Tahap **Implementation** adalah fase di mana kode benar-benar ditulis. Berbekal semua rancangan dari tahap-tahap sebelumnya, para programmer akan mulai 'membangun' perangkat lunak baris demi baris. Tahap ini membutuhkan ketelitian tinggi, pemahaman sintaks, dan logika pemrograman yang kuat agar hasil akhirnya sesuai dengan apa yang dirancang.",
    },
  },
  'sdlc-testing': {
    title: "Mencari Bug",
    description: "Selamat datang di tahap Testing! Sekarang kita harus memastikan semua yang telah dibangun tidak memiliki cacat. Kamu harus teliti mencari dan membasmi semua 'bug' yang tersembunyi!",
    missionText: "Misi: Temukan dan perbaiki semua 5 'bug' (🐛) yang ada di dinding kode!",
    emoji: '🐛',
    game: {
      type: 'testing',
      bugCount: 5,
    ...
    material: {
      ...
      description: "Tahap **Testing** adalah proses pengujian untuk memastikan perangkat lunak berfungsi sesuai harapan dan bebas dari kesalahan atau bug. Para tester akan mencoba berbagai skenario untuk menemukan bug-bug tersembunyi. Tahap ini sangat penting untuk menjaga kualitas dan keandalan produk sebelum sampai ke tangan pengguna.",
    },
  },
  'sdlc-maintenance': {
    title: "Kebun Pemeliharaan",
    description: "Akhirnya kita sampai di tahap Maintenance! Tugas pahlawan kode tidak pernah selesai. Sekarang kamu harus menjaga dan memelihara Istana yang sudah kamu bangun agar selalu indah dan berfungsi dengan baik.",
